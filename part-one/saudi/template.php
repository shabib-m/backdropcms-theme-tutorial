 ...
 */
function saudi_css_alter(&$css) {
  $theme_path = backdrop_get_path('theme', 'saudi');

  if ($bootstrap_cdn = theme_get_setting('saudi_cdn')) {
    // Add CDN.
    if ($bootswatch = theme_get_setting('saudi_bootswatch')) {
  ...
  if ($font_awesome = theme_get_setting('saudi_font_awesome')) {
 ...
 */
function saudi_js_alter(&$js) {
  if (theme_get_setting('saudi_cdn')) {
    $cdn = 'https://cdn.jsdelivr.net/npm/bootstrap@' . theme_get_setting('saudi_cdn')  . '/dist/js/bootstrap.min.js';
 ...
 */
function saudi_preprocess_page(&$variables) {
  ...
  if (saudi_is_header('get')) {
    ...
    if ($navbar_position = theme_get_setting('saudi_navbar_position')) {
      ...
      if (function_exists('admin_bar_suppress') &&  $navbar_position == 'fixed-top' && user_access('access administration bar') && !admin_bar_suppress(FALSE) && !$config->get('position_fixed') ) {
        backdrop_add_js(backdrop_get_path('theme', 'saudi') . '/js/navbar-fixed-top.js');
      }
      if ($navbar_position == 'static-top') {
        backdrop_add_js(backdrop_get_path('theme', 'saudi') . '/js/navbar-static-top.js');
      }
    }
  }
 ...
 */
function saudi_preprocess_header(&$variables) {
  $variables['navigation'] = '';
  $navbar_menu_position = theme_get_setting('saudi_navbar_menu_position');
  ...
  if ($navbar_position = theme_get_setting('saudi_navbar_user_menu')) {
  ...
  $variables['container_class'] = theme_get_setting('saudi_container');

  $navbar_style = theme_get_setting('saudi_navbar_style');
 ...
 */
function saudi_links__header_menu($menu) {
  $menu['attributes']['class'] = array('menu','nav','navbar-nav');
  if ($navbar_menu_position = theme_get_setting('saudi_navbar_menu_position')) {
 ...
 * Implements hook_links().
 */
function saudi_links__user_menu($menu) {
  //$menu['attributes']['class'] = array('menu','nav','navbar-nav');
  if ($navbar_menu_position = theme_get_setting('saudi_navbar_menu_position')) {
    $menu['attributes']['class'][] = $navbar_menu_position;
  }
 ...
 */
function saudi_menu_tree__user_menu($variables) {
  if ($navbar_position = theme_get_setting('saudi_navbar_user_menu')) {
 ...
 * @ingroup themeable
 */
function saudi_fieldset($variables) {
  //dpm($variables);
 ...
 * @ingroup themeable
 */
function saudi_button($variables) {
 ...
 * @ingroup themeable
 */
function saudi_email($variables) {
 ...
 * @ingroup themeable
 */
function saudi_webform_email($variables) {
  $variables['element']['#attributes']['class'][] = 'form-control';
 ...
 * @ingroup themeable
 */
function saudi_textfield($variables) {
  $variables['element']['#attributes']['class'][] = 'form-control';
 ...
 * @ingroup themeable
 */
function saudi_textarea($variables) {
  $variables['element']['#attributes']['class'][] = 'form-control';
 ...
 * @ingroup themeable
 */
function saudi_checkbox($variables) {
 ...
 * @ingroup themeable
 */
function saudi_radio($variables) {
  $variables['element']['#attributes']['class'][] = 'form-check-input';
 ...
 * @ingroup themeable
 */
function saudi_form_element($variables) {
 ...
 * @ingroup themeable
 */
function saudi_password($variables) {
  $variables['element']['#attributes']['class'][] = 'form-control';
 ...
 * @ingroup themeable
 */
function saudi_search($variables) {
 ...
 * @ingroup themeable
 */
function saudi_select($variables) {
 ...
 */
function saudi_preprocess_table(&$variables) {
 ...
 * @ingroup themeable
 */
function saudi_user_permission_description($variables) {
  $description = array();
 ...
 * @ingroup themeable
 */
function saudi_admin_block($variables) {
 ...
 * @ingroup themeable
 */
function saudi_system_admin_index($variables) {
 ...
 * @ingroup themeable
 */
function saudi_admin_page($variables) {
 ...
 */
function saudi_menu_local_tasks(&$variables) {
  $output = '';
 ...
 * Implements hook_links().
 */
function saudi_links__dropbutton($menu) {
 ...
 */
function saudi_menu_local_actions(&$variables) {
 ...
 */
function saudi_breadcrumb($variables) {
 ...
 */
function saudi_preprocess_breadcrumb(&$variables) {
  $breadcrumb = &$variables['breadcrumb'];

  // Optionally get rid of the homepage link.
  $show_breadcrumb_home = theme_get_setting('saudi_breadcrumb_home');
  if (!$show_breadcrumb_home) {
    array_shift($breadcrumb);
  }
  if (theme_get_setting('saudi_breadcrumb_title') && !empty($breadcrumb)) {
    $item = menu_get_item();
 ...
 * @ingroup themeable
 */
function saudi_container($variables) {
 ...
 */
function saudi_preprocess_views_view_table(&$variables) {
 ...
 */
function saudi_form_alter(array &$form, array &$form_state = array(), $form_id = NULL) {
  if ($form_id) {
 ...
 */
function saudi_node_add_list($variables) {
 ...
 */
function saudi_admin_block_content($variables) {
  return saudi_node_add_list($variables);
}
 ...
 */
function saudi_preprocess_user_picture(&$variables) {
 ...
 */
function saudi_preprocess_comment(&$variables) {
  if (theme_get_setting('saudi_datetime')) {
 ...
 */
function saudi_preprocess_node(&$variables) {
  if (theme_get_setting('saudi_datetime')) {
...
function saudi_progress_bar($variables) {
